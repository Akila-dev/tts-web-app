...
__all__ = [ 'LoadPictureConstants', 'VgaColor', 'StdPicture',
           'OLE_YPOS_PIXELS', 'OLE_YPOS_HIMETRIC', 'Color',
           'OLE_XPOS_PIXELS', 'FontEvents', 'OLE_XSIZE_PIXELS',
           'OLE_YSIZE_CONTAINER', 'Monochrome', 'OLE_YSIZE_PIXELS',
           'FONTITALIC', 'FONTBOLD', 'IFont', 'OLE_TRISTATE',
           'OLE_ENABLEDEFAULTBOOL', 'FONTSTRIKETHROUGH', 'Font',
           'Default', 'IFontEventsDisp', 'OLE_XSIZE_CONTAINER',
           'StdFont', 'IFontDisp', 'Picture', 'OLE_OPTEXCLUSIVE',
           'Checked', 'Gray', 'OLE_XPOS_CONTAINER',
           'OLE_YPOS_CONTAINER', 'Unchecked', 'IPictureDisp',
           'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_HIMETRIC', 'OLE_HANDLE',
           'FONTUNDERSCORE', 'FONTNAME', 'OLE_COLOR', 'IPicture',
           'OLE_XSIZE_HIMETRIC', 'FONTSIZE', 'OLE_CANCELBOOL']
from comtypes import _check_version; _check_version('1.1.11', 1632989208.6207287)
